    ...
    <form id="form1" runat="server">
        ...
        <div class="Quiz1">
            ...
            <asp:Label ID="Q1" CssClass="QuestionText1" runat="server" Text=""> Spørsmål 1:</asp:Label>
                <asp:Label ID="Label1"  CssClass="QT1" runat="server" Text="Hva bruker man InDesign mest til?"></asp:Label>
        ...
        <div class="Quiz2">
            ...
            <asp:Label ID="Q2" CssClass="QuestionText2" runat="server" Text="">Spørsmål 2:</asp:Label>
                 <asp:Label ID="Label2"  CssClass="QT2" runat="server" Text="Hvordan lager du et dokument/prosjekt?"></asp:Label>
        ...
        <div class="Quiz3">
            <center>
             <asp:Label ID="Q3" CssClass="QuestionText3" runat="server" Text="">Spørsmål 3:</asp:Label>
                 <asp:Label ID="Label3"  CssClass="QT3" runat="server" Text="Hvordan bytter man målinger? feks: cm, mm, inches osv."></asp:Label>
        ...
        <div class="Quiz4">
            <center>
             <asp:Label ID="Q4" CssClass="QuestionText4" runat="server" Text="">Spørsmål 4:</asp:Label>
                 <asp:Label ID="Label4"  CssClass="QT4" runat="server" Text="Hva er bleed, slug og margin?"></asp:Label>
        ...
        <div class="Quiz5">
            <center>
             <asp:Label ID="Q5" CssClass="QuestionText5" runat="server" Text="">Spørsmål 5:</asp:Label>
                 <asp:Label ID="Label5"  CssClass="QT5" runat="server" Text="Hvordan lagrer du et dokument/prosjekt?"></asp:Label>
        ...
        <div class="Quiz6">
            ...
            <asp:Label ID="Q6" CssClass="QuestionText6" runat="server" Text="">Spørsmål 6:</asp:Label>
                 <asp:Label ID="Label6"  CssClass="QT6" runat="server" Text="Nevn 4 verktøy som du tror er nyttig i InDesign."></asp:Label>
        ...
        <div class="Quiz7">
            ...
            <asp:Label ID="Q7" CssClass="QuestionText7" runat="server" Text="">Spørsmål 7:</asp:Label>
                 <asp:Label ID="Label7"  CssClass="QT7" runat="server" Text="Hvordan lager du farger? Hva er swatches?"></asp:Label>
        ...
        <div class="Quiz8">
            <center>
             <asp:Label ID="Q8" CssClass="QuestionText8" runat="server" Text="">Spørsmål 8:</asp:Label>
                 <asp:Label ID="Label8"  CssClass="QT8" runat="server" Text="Hva er layers? Er layers viktig?"></asp:Label>
        ...
        <div class="Quiz9">
            ...
            <asp:Label ID="Q9" CssClass="QuestionText9" runat="server" Text="">Spørsmål 9:</asp:Label>
                 <asp:Label ID="Label9"  CssClass="QT9" runat="server" Text="Hvis du skal lage en bakgrunn ved bruk av rektangel verktøy, hvor plasserer du den?"></asp:Label>
        ...
        <div class="Quiz10">
            ...
            <asp:Label ID="Q10" CssClass="QuestionText10" runat="server" Text="">Spørsmål 10:</asp:Label>
                 <asp:Label ID="Label10"  CssClass="QT10" runat="server" Text="Hvordan kan man på enklest mulig måte endre størrelse på et bilde?"></asp:Label>
        ...
        <div class="Quiz11">
            <center>
             <asp:Label ID="Q11" CssClass="QuestionText11" runat="server" Text="">Spørsmål 11:</asp:Label>
                 <asp:Label ID="Label11"  CssClass="QT11" runat="server" Text="Hvordan velger du fonter på tekster?"></asp:Label>
        ...
        <div class="Quiz12">
            ...
            <asp:Label ID="Q12" CssClass="QuestionText12" runat="server" Text="">Spørsmål 12:</asp:Label>
                 <asp:Label ID="Label12"  CssClass="QT12" runat="server" Text="Hvordan eksporterer du et dokument/prosjekt?"></asp:Label>
